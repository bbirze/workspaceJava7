...
public class VarargExceptions {
	...
	//@SuppressWarnings("unchecked")             // JDK 6
	...
	public static void main(String[] args) {
		VarargExceptions ve = new VarargExceptions();
		ve.heapPollution();

		VarargExceptions.pauseConsole("Vararg methods with Non-Reifiable Parameters");
		List<String> lst1 = new ArrayList<String>();
		List<String> lst2 = new ArrayList<String>();
		ve.varargMethod(lst1, lst2);
		
		VarargExceptions.pauseConsole("How to Suppress Warnings with Annotations");
